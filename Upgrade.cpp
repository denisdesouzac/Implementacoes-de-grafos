...
/*int agm_original(vector<pair<int, ii>> arestas2,  int m){
    int resultado = 0;
    for(int i = 0; i<m; i++){
         resultado += arestas2[i].first;
    }
    return resultado;
}*/
...
int main()
{
    ...
    cin >> quantidadeDeTestes;
        ...
        for(int contadorDeTestes = 0; contadorDeTestes < quantidadeDeTestes; contadorDeTestes++){
            ...
            result_1 = kruskall(arestas, n, m, primeiraAgm);
            result_2 = segundaMenorAgm(arestas, n, m, primeiraAgm);
           // cout << "Result 1 antes if:" << result_1 << endl;
           // cout << "Result 2 antes if:" << result_2 << endl;

            if (result_1 > result_2){
                //result_1 = agm_original(arestas, n, m);
                result_2 = result_1;
               // cout << "Result 1 dentro if:" << result_1 << endl;
               // cout << "Result 2 dentro if:" << result_2 << endl;
           }/*else if(result_2 == 0){
                 result_2 = agm_original(arestas, n, m);
                 cout << "Result 1 dentro else if:" << result_1 << endl;
                cout << "Result 2 dentro else if:" << result_2 << endl;
            }*/
           // cout << "FINAL:"<< endl;
