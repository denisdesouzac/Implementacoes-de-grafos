...
//Variação do Dijkstra que já testa removendo 1 aresta por vez
int dijkstra2(int n, int s, int t, int i){
    // vetor de distâncias
    int dist[n];
    ...
    //removerArestas(caminhos[i],caminhos[i+1]); // Fazer com que o dijkstra 2 remova e já teste, dps chame dnv
